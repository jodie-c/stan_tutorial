...
model_file <- "/Users/chengu/Documents/master thesis/final_final_final_code/stan_file_for_pooling_method/nopooling_complete_0703.stan"
output_dir <- "/Users/chengu/Documents/master thesis/final_final_final_code/pooling_methods_rds"
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)
data_output_file <- file.path(output_dir, "stan_data_no_pooling.rds")
fit_output_file <- file.path(output_dir, "stan_fit_no_pooling.rds")
