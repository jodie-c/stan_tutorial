...
data_output_file <- file.path(output_dir, "stan_data_partial_noncentered_noforget.rds")
fit_output_file <- file.path(output_dir, "stan_fit_partial_noncentered_noforget.rds")
